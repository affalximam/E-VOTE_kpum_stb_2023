...
<body>
    ...
    <section class="add-voters">
        <div class="container">
            <div class="row">
                <h1>ALLOWED IP TO VOTE</h1>
            </div>
            <div class="row">
                <form method="post">
                    <label class="mt-3 mb-1">Nama : </label>
                    <input type="text" name="name" placeholder="nama">
                    <label class="mt-3 mb-1">Ip Address : </label>
                    <input type="text" name="ip_address" placeholder="ip-address">
                    <button type="submit" name="add_ip_address" class="btn btn-lg btn-primary mt-3">SUBMIT</button>
                </form>
            </div>
        </div>
    </section>
